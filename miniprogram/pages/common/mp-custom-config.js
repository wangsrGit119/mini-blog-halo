    ...
    let config = {
      myStyle:{
        tagStyle:{
          ...
          ul: 'font-size: 12px;padding-left: 15px;line-height: 1.85;',
          ol: 'font-size: 12px;padding-left: 15px;line-height: 1.85;',
          li: 'font-size: 12px;margin-bottom: 12px;line-height: 1.85;',
          ...
          p: 'line-height: 1.85;margin: 0.8em 0;font-size: 12px;',
          'code': 'word-wrap:break-word;color:#ae99cd;font-size:12px;margin:0 2px 0 2px;',
          strong:'font-weight: 700;color: rgb(0, 0, 0);',
          video: 'width: 100%'
        },
    ...
    let config = {
      myStyle:{
        tagStyle:{
          ...
          h4: 'font-size: 0.67em;line-height: 30px;',
          h5: 'font-size: 0.50em;line-height: 30px;',
          p: 'line-height: 1.85;margin: 0.2em 0;font-size: 12px;',
          'code': 'word-wrap:break-word ;color:#ae99cd;font-size:12px;margin:0 2px 0 2px;',
          strong:'font-weight: 700;color: rgb(0, 0, 0);',
          video: 'width: 100%',
